...
const Footer = () => {
  return (
    <div className="footer fixed bottom-0 left-0 w-full bg-gray-200 py-6">
      ...
      <div className=" text-center text-gray-700 mt-4 w-full ml-[40%]">
        <p className="text-center">
          &copy; 2024 HeartBridge. All rights reserved.
        </p>
      </div>
    </div>
  );
